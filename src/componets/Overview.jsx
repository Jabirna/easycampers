  ...
  return (
    <div className='w-full flex flex-wrap min-h-[500px] p-3' style={divStyle}>
        <div className='max-md:w-full w-[50%] '>
            ...
            <button className='mt-10 w-full p-4 text-white font-mono font-extrabold bg-green-400 rounded-lg shadow-xl text-[20px] hover:ring-1 hover:ring-green-100 hover:shadow-lg' >BOOKING NOW</button>
        </div>
