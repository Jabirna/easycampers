    ...
    <div>
        <div className='p-3 flex flex-wrap justify-center'>
            {services.map((item,indx)=>{
                return(
                    <div key={indx} className='max-sm:w-full w-[300px] h-[420px] hover:p-0 p-1 border-1 border-gray-400 shadow-2xl rounded-lg mt-2 mr-2 cursor-pointer duration-500'>
