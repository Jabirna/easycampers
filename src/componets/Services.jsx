...
const Services = () => {
    const services=[{img:slideImg[0].img,head:"Tent Stay",desc:`best camp experience at Kolukkumai Munnar. it includes both sunrise and sunset trekking.
                    ...
                    {img:slideImg[3].img,head:`Campfire`,desc:`Campfire and DJ: Unwind in the evening with a cozy campfire, where stories are shared, laughter fills the air, and memories are made. Our DJ will keep the party going, ensuring a night to remember.`}
                ]
  return (
    <div>
